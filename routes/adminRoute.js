...
adminRoute.get('/home', adminController.userSearch);

adminRoute.get('/usermanagement', adminController.adminDashboard);
adminRoute.get('/users', adminController.getUsers);
adminRoute.post('/users/:userId/block', adminController.blockUser);
adminRoute.post('/users/:userId/unblock', adminController.unblockUser);
adminRoute.post('/users/:userId/toggle-block', adminController.toggleUserBlock);
...
adminRoute.post('/products/update-offer/:id', productController.updateProductOffer);
...
adminRoute.get('/orders', adminOrderController.listOrdersAdmin);

adminRoute.post('/orders/update-order-status', adminOrderController.updateOrderStatus);
